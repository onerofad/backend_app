...
from backend_app.views import RegisterView, UploadedFilesView, UploadedAudioView, UploadedVideoView, NoteView, Form1View
...
router.register('forms1', Form1View, 'form1')
