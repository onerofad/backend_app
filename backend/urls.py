...
from backend_app.views import RegisterView, UploadedFilesView, UploadedAudioView, UploadedVideoView, NoteView, ProfileDetail
...
router.register('profile-detail', ProfileDetail, 'profile-details')
