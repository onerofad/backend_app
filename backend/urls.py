...
from backend_app.views import RegisterView, UploadedFilesView, UploadedAudioView, UploadedVideoView, NoteView, CustomViewSet
...
router.register('forms', CustomViewSet, 'form')
